...
// ====== CONFIG (smaller + top-left) ======
// Use 0.5 for crisp half-size pixel art
ui_scale_hp      = 0.4;   // skull, vine, moons
ui_scale_chalice = 0.35;   // chalice + number

// Tight margins in the corner
margin_x = 30;
margin_y = 50;

// Spacing tuned for half-scale
moon_gap_px     = 2;
anim_speed      = 0.6;
skull_alert_ms  = 10;
...
row_gap_px      = 4;
hp_y_offset     = 2;
skull_y_nudge   = 20;     // was 65 at 1.0 scale; 20 suits 0.5
antler_bridge_px = 10;    // shorter bridge at smaller size
